...
— of those nine, #483 and #485–#491 (eight issues) are closed and shipped
in full; only [#484](https://github.com/s3ntin3l8/mullion-session-manager/issues/484)
(Task Master support for remote-hosted projects) remains open, tracking
the promotion/ingest/orphan-sweep gaps `docs/tasks.md`'s Known limitations
section describes.
...
| Issue                                                                                                                                      | How it fits                                                                                                                                                              | Status                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------- |
| [#157](https://github.com/s3ntin3l8/mullion-session-manager/issues/157) — Phase 7: Secure Agent Lifecycle & Discovery                      | Parent tracking issue, retitled to match the milestone. Carries the full original design doc; 7.1–7.7 (7.6 excepted) below are linked to it as native GitHub sub-issues. | Closed — completed                                         |
