...
PROJECTS_ROOTS=${MULLION_AGENT_PROJECTS_ROOTS:-}
...
# on the primary too.
MULLION_PRIMARY_URL=${MULLION_AGENT_PRIMARY_URL:-}
MULLION_ENROLLMENT_TOKEN=${MULLION_AGENT_ENROLLMENT_TOKEN:-}
MULLION_AGENT_ADVERTISE_URL=${MULLION_AGENT_ADVERTISE_URL:-}
MULLION_AGENT_NAME=${MULLION_AGENT_NAME:-}
