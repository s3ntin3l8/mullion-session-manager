...
## [0.3.26](https://github.com/s3ntin3l8/mullion-session-manager/compare/v0.3.25...v0.3.26) (2026-09-19)
...
* **bundle-sync:** add status/resync/remove surface for issues [#944](https://github.com/s3ntin3l8/mullion-session-manager/issues/944)/[#945](https://github.com/s3ntin3l8/mullion-session-manager/issues/945) ([#1085](https://github.com/s3ntin3l8/mullion-session-manager/issues/1085)) ([fbc690f](https://github.com/s3ntin3l8/mullion-session-manager/commit/fbc690f4230feb01af9d11d7cac800a9b85f15fe))
* **bundle-sync:** agent-host query/remove surface ([#1129](https://github.com/s3ntin3l8/mullion-session-manager/issues/1129)) ([88b9a90](https://github.com/s3ntin3l8/mullion-session-manager/commit/88b9a905f6d0678faf8e5abbc33ef7f473fd1f48))
* **bundle,tasks:** add task-reviewer skill and thread rounds-remaining into the review prompt ([#955](https://github.com/s3ntin3l8/mullion-session-manager/issues/955)) ([#1109](https://github.com/s3ntin3l8/mullion-session-manager/issues/1109)) ([f2a434a](https://github.com/s3ntin3l8/mullion-session-manager/commit/f2a434a09846cd3a141035c591a42e95ea5c7758))
* **bundle,tasks:** add task-worker skill and make the unattended rule unconditional ([#964](https://github.com/s3ntin3l8/mullion-session-manager/issues/964)) ([#1105](https://github.com/s3ntin3l8/mullion-session-manager/issues/1105)) ([f718c2f](https://github.com/s3ntin3l8/mullion-session-manager/commit/f718c2fda3c7ae044cdd0aef6ef37020f2336175))
* decompose agent guide into inert bundle skills ([#1011](https://github.com/s3ntin3l8/mullion-session-manager/issues/1011)) ([ad6ac4c](https://github.com/s3ntin3l8/mullion-session-manager/commit/ad6ac4ca3c2ef194922d08ac8b5cf672407f6b85))
* **dock:** group discovered services by compose project and hoist stack actions ([#1110](https://github.com/s3ntin3l8/mullion-session-manager/issues/1110)) ([5d5ec0e](https://github.com/s3ntin3l8/mullion-session-manager/commit/5d5ec0e771df340cb53182a09a1e6d8d357f0151))
* expand and correct the taskmaster-issues skill ([#1031](https://github.com/s3ntin3l8/mullion-session-manager/issues/1031)) ([26cc554](https://github.com/s3ntin3l8/mullion-session-manager/commit/26cc55413527dc426ab17bb103df9b11d0623072))
* **host-git,project-setup:** support writing scaffold file content on a remote host ([#1102](https://github.com/s3ntin3l8/mullion-session-manager/issues/1102)) ([0adde87](https://github.com/s3ntin3l8/mullion-session-manager/commit/0adde87ff670318e3d259ea91b8b8e4e3be825fd))
* host-local content sync for bundle skills/agents ([#941](https://github.com/s3ntin3l8/mullion-session-manager/issues/941)) ([#1066](https://github.com/s3ntin3l8/mullion-session-manager/issues/1066)) ([d10da9b](https://github.com/s3ntin3l8/mullion-session-manager/commit/d10da9b685c6ee76062cb5d39b3caa40a96bc4ce))
* minimal dynamic SessionStart push (tier-0), all four CLIs ([#1024](https://github.com/s3ntin3l8/mullion-session-manager/issues/1024)) ([9efd564](https://github.com/s3ntin3l8/mullion-session-manager/commit/9efd564419575fc3ec86c2a4c41e04a3bd502b30))
* **project-setup:** run /setup/generate's agent turn on the owning host ([#1134](https://github.com/s3ntin3l8/mullion-session-manager/issues/1134)) ([70e3e3b](https://github.com/s3ntin3l8/mullion-session-manager/commit/70e3e3b640c81501a11d9caedc51a51ce9fa2ddc))
* **projects:** auto-enable Conventional Commits titles for release-please repos ([#1037](https://github.com/s3ntin3l8/mullion-session-manager/issues/1037)) ([fe8819c](https://github.com/s3ntin3l8/mullion-session-manager/commit/fe8819ceb76cdf2ab67102c4a86fd914bf6f31fb))
* **projects:** re-check release-please detection when a repo adopts it later ([#1034](https://github.com/s3ntin3l8/mullion-session-manager/issues/1034)) ([#1042](https://github.com/s3ntin3l8/mullion-session-manager/issues/1042)) ([a7843c3](https://github.com/s3ntin3l8/mullion-session-manager/commit/a7843c37d8233ff8c2aca5ca0b27c591cea10e71))
* **scaffold,bundle-sync:** stop double-delivering scaffolded content and converge Claude Code/opencode bundle removal onto next launch ([#1095](https://github.com/s3ntin3l8/mullion-session-manager/issues/1095)) ([941a6c1](https://github.com/s3ntin3l8/mullion-session-manager/commit/941a6c16dc3ab88a20dbb786345aba979ffeef34))
* **scaffold:** diff-aware refresh for /setup/generate, verify agent sandboxing ([#1082](https://github.com/s3ntin3l8/mullion-session-manager/issues/1082), [#1081](https://github.com/s3ntin3l8/mullion-session-manager/issues/1081)) ([#1096](https://github.com/s3ntin3l8/mullion-session-manager/issues/1096)) ([72c9898](https://github.com/s3ntin3l8/mullion-session-manager/commit/72c98989f281e4a9ad9ebcbdc31e6f4c0e94f519))
* **scaffold:** write workflow conventions into a scaffolded AGENTS.md ([#1114](https://github.com/s3ntin3l8/mullion-session-manager/issues/1114)) ([be3cfd1](https://github.com/s3ntin3l8/mullion-session-manager/commit/be3cfd1dcbb96e1efcd1d16aab996e40c30b0bc5))
* **security:** real process-level sandboxing for scaffold-generate's agent turn ([#1132](https://github.com/s3ntin3l8/mullion-session-manager/issues/1132)) ([1844524](https://github.com/s3ntin3l8/mullion-session-manager/commit/1844524e7a89601f8e7e135a79dcdfc7dac89b93))
* **sessions:** add global workflow conventions text + wizard ([#937](https://github.com/s3ntin3l8/mullion-session-manager/issues/937)) ([#1067](https://github.com/s3ntin3l8/mullion-session-manager/issues/1067)) ([d56db0c](https://github.com/s3ntin3l8/mullion-session-manager/commit/d56db0ce29a475dcebd1ab5e1283eedfae9bd388))
* **settings:** add bundle sync status/re-sync/remove panel ([#944](https://github.com/s3ntin3l8/mullion-session-manager/issues/944), [#945](https://github.com/s3ntin3l8/mullion-session-manager/issues/945)) ([#1086](https://github.com/s3ntin3l8/mullion-session-manager/issues/1086)) ([c687f36](https://github.com/s3ntin3l8/mullion-session-manager/commit/c687f36f234b1d45c15572e58b1b0cc8a396b617))
* **skills:** discover agy's global agents dir for Skills Manager ([#1080](https://github.com/s3ntin3l8/mullion-session-manager/issues/1080)) ([#1093](https://github.com/s3ntin3l8/mullion-session-manager/issues/1093)) ([4b7fbea](https://github.com/s3ntin3l8/mullion-session-manager/commit/4b7fbeac665b01fe11174450312a834e0d95a1bc))
* **ssh-agent:** add --insecure flag for self-signed/TLS proxy deployments ([#1064](https://github.com/s3ntin3l8/mullion-session-manager/issues/1064)) ([27edefe](https://github.com/s3ntin3l8/mullion-session-manager/commit/27edefeb5fc8d5fb3b996291138247e63871e64d))
* **ssh-agent:** add architecture check to macOS .pkg build script ([#1063](https://github.com/s3ntin3l8/mullion-session-manager/issues/1063)) ([4c2259d](https://github.com/s3ntin3l8/mullion-session-manager/commit/4c2259d0b19a2b808f5e4d1af2e6271e47103f7a))
* **ssh-agent:** detect ambient SSH_AUTH_SOCK in macOS postinstall ([#1084](https://github.com/s3ntin3l8/mullion-session-manager/issues/1084)) ([7b65b95](https://github.com/s3ntin3l8/mullion-session-manager/commit/7b65b95b38b8e46ff418cfdbf10ae57cea8530b2))
* **ssh-agent:** honor Retry-After header on 429 renewal ([#1075](https://github.com/s3ntin3l8/mullion-session-manager/issues/1075)) ([0277255](https://github.com/s3ntin3l8/mullion-session-manager/commit/0277255bd8d69496093bf8991f687536b70e455e))
* **tasks:** a PR-title lint failure shouldn't burn a worker's auto-return round ([#1035](https://github.com/s3ntin3l8/mullion-session-manager/issues/1035)) ([#1044](https://github.com/s3ntin3l8/mullion-session-manager/issues/1044)) ([8167ae0](https://github.com/s3ntin3l8/mullion-session-manager/commit/8167ae0f3b286f07f9ba142d372504a78dce3ca8))
* **tasks:** add rate-limit grace window for Task Master ([#1027](https://github.com/s3ntin3l8/mullion-session-manager/issues/1027)) ([d0f667e](https://github.com/s3ntin3l8/mullion-session-manager/commit/d0f667e7a1349fe93500421dce2a8e01ed44c8ca))
* **tasks:** add worker self-review to the Task Master worker contract ([#1012](https://github.com/s3ntin3l8/mullion-session-manager/issues/1012)) ([121901c](https://github.com/s3ntin3l8/mullion-session-manager/commit/121901c5b626043835117ba5b63a4a08ca28c7d4))
* **tasks:** archive done tasks once their PR is merged ([#1026](https://github.com/s3ntin3l8/mullion-session-manager/issues/1026)) ([f8b6a3d](https://github.com/s3ntin3l8/mullion-session-manager/commit/f8b6a3d4e1b496b1c90663b4f8c0f9398f975a15))
* **tasks:** give a worker's prompt its issue comments and parent-epic context ([#1025](https://github.com/s3ntin3l8/mullion-session-manager/issues/1025)) ([c8df759](https://github.com/s3ntin3l8/mullion-session-manager/commit/c8df759089fb7d16d3fe96c8324fe642e66160f7))
* **tasks:** re-review a capped task after an out-of-band human push ([#1041](https://github.com/s3ntin3l8/mullion-session-manager/issues/1041)) ([73c78f4](https://github.com/s3ntin3l8/mullion-session-manager/commit/73c78f4b9271b15afc4197c64131a8975a5ce58c))
* **tasks:** warn before Approve closes a tracking epic with open sub-issues ([#1020](https://github.com/s3ntin3l8/mullion-session-manager/issues/1020)) ([#1045](https://github.com/s3ntin3l8/mullion-session-manager/issues/1045)) ([43b85a4](https://github.com/s3ntin3l8/mullion-session-manager/commit/43b85a41838cd1d715eb16b2eec2a948b526997a))
* **terminal:** add browser-based voice dictation (push-to-talk) ([#1126](https://github.com/s3ntin3l8/mullion-session-manager/issues/1126)) ([c854012](https://github.com/s3ntin3l8/mullion-session-manager/commit/c854012adda7791fb1cda0964b833a209a139a4f))


### Bug Fixes

* 429 client breaker should gate on the shared bucket, not the URL key ([a41ed1e](https://github.com/s3ntin3l8/mullion-session-manager/commit/a41ed1e849fa5c7cf85f28acdee1b0ad1ed340ce))
* **bundle-sync:** orphan discovery for AGENT_TARGETS ([#1127](https://github.com/s3ntin3l8/mullion-session-manager/issues/1127)) ([7143ab7](https://github.com/s3ntin3l8/mullion-session-manager/commit/7143ab71245d86fdbe6fedafc9f50ab21dec6cf6))
* **bundle-sync:** prune marker-carrying orphan skill dirs with no manifest entry ([#947](https://github.com/s3ntin3l8/mullion-session-manager/issues/947)) ([#1091](https://github.com/s3ntin3l8/mullion-session-manager/issues/1091)) ([434b575](https://github.com/s3ntin3l8/mullion-session-manager/commit/434b575ac27af7aaf200f84981988fecb7baa13f))
* **bundle-sync:** thread injectMullionBundle to agent hosts, guard plugin registration ([#1089](https://github.com/s3ntin3l8/mullion-session-manager/issues/1089)) ([#1092](https://github.com/s3ntin3l8/mullion-session-manager/issues/1092)) ([666bd09](https://github.com/s3ntin3l8/mullion-session-manager/commit/666bd0941df35a1451dafb560f70f9c7b7924e5b))
* **ci:** add end-to-end mullion helper run test for macOS ([#1094](https://github.com/s3ntin3l8/mullion-session-manager/issues/1094)) ([1088798](https://github.com/s3ntin3l8/mullion-session-manager/commit/1088798fab28b3fcb4b9c33e9bc8c882bde95081))
* **dock:** keep the Docker kebab reachable and open it upward ([#1108](https://github.com/s3ntin3l8/mullion-session-manager/issues/1108)) ([5e503e6](https://github.com/s3ntin3l8/mullion-session-manager/commit/5e503e687eb02ce4430df066c16d78c89db49437))
* exempt static assets from the rate limiter, batch git-refs, dedupe reloads ([#1017](https://github.com/s3ntin3l8/mullion-session-manager/issues/1017)) ([15dd6af](https://github.com/s3ntin3l8/mullion-session-manager/commit/15dd6afbe90352086391636a65b673765131801a))
* **github-write:** RELEASE_WORKFLOW_FILENAMES misses repos naming their workflow release.yml ([#1033](https://github.com/s3ntin3l8/mullion-session-manager/issues/1033)) ([#1043](https://github.com/s3ntin3l8/mullion-session-manager/issues/1043)) ([b95f1e4](https://github.com/s3ntin3l8/mullion-session-manager/commit/b95f1e4b1c69170aa0058ba788eb4c69f3ef0044))
* remove model badges from tab/sidebar, show model in kebab menu ([#1019](https://github.com/s3ntin3l8/mullion-session-manager/issues/1019)) ([45ca281](https://github.com/s3ntin3l8/mullion-session-manager/commit/45ca28170b6432e4fc5dbfcc90113bb7ac03c157))
* retriable lazy() wrapper so pane Reload can recover a rejected chunk load ([#1032](https://github.com/s3ntin3l8/mullion-session-manager/issues/1032)) ([81d132d](https://github.com/s3ntin3l8/mullion-session-manager/commit/81d132df7621464dad840d655159147be634f8f9))
* root crash screen copy, error detail, and retriable lazy panels ([#1022](https://github.com/s3ntin3l8/mullion-session-manager/issues/1022)) ([d67aa76](https://github.com/s3ntin3l8/mullion-session-manager/commit/d67aa76f958e5c120a7c8d786b13fae70bd6dd47))
* **scaffold:** gate on any committed scaffold, not the stamped slug ([#1122](https://github.com/s3ntin3l8/mullion-session-manager/issues/1122)) ([9a5c02a](https://github.com/s3ntin3l8/mullion-session-manager/commit/9a5c02a9ca23cf02c4247c64e0022c8111b8900e))
* **ssh-agent:** add missing WebSocket error handler on bridge route ([#1062](https://github.com/s3ntin3l8/mullion-session-manager/issues/1062)) ([1146f73](https://github.com/s3ntin3l8/mullion-session-manager/commit/1146f739664f78c0729430192fb0dc86da6218d2))
* **ssh-agent:** bound openSockets Set and add pickBridge health check ([#1076](https://github.com/s3ntin3l8/mullion-session-manager/issues/1076)) ([2ae9bac](https://github.com/s3ntin3l8/mullion-session-manager/commit/2ae9bacfc2680582c1c96a7104743518888bbd94))
* **ssh-agent:** close TOCTOU gap in bridge revocation ([#1078](https://github.com/s3ntin3l8/mullion-session-manager/issues/1078)) ([479470b](https://github.com/s3ntin3l8/mullion-session-manager/commit/479470b4152ba334c603c59cce23f0a4031f8bb8))
* **ssh-agent:** harden SEA build and add unhandledRejection handler ([#1073](https://github.com/s3ntin3l8/mullion-session-manager/issues/1073)) ([48cd23b](https://github.com/s3ntin3l8/mullion-session-manager/commit/48cd23bd05c48224414fca6944ebed1c1b5c51d1))
* **ssh-agent:** improve macOS .pkg postinstall with binary check and Gatekeeper guidance ([#1065](https://github.com/s3ntin3l8/mullion-session-manager/issues/1065)) ([9aea1fd](https://github.com/s3ntin3l8/mullion-session-manager/commit/9aea1fdd15c0d0c8fce2f7da3601f393fbd3d047))
* **ssh-agent:** validate baseUrl and bound allocateChannelId loop ([#1074](https://github.com/s3ntin3l8/mullion-session-manager/issues/1074)) ([85e38a7](https://github.com/s3ntin3l8/mullion-session-manager/commit/85e38a70b42f5822c4f2ffe85038376a963e06f5))
* **tasks:** force-delete a failed task (Abandon) past the preserved-branch guard ([#1018](https://github.com/s3ntin3l8/mullion-session-manager/issues/1018)) ([765e129](https://github.com/s3ntin3l8/mullion-session-manager/commit/765e1297624da133ca6662b0fbab85cd904f25b8))
* **tasks:** guard against dispatching a tracking-epic issue to a worker ([#1023](https://github.com/s3ntin3l8/mullion-session-manager/issues/1023)) ([f0699c4](https://github.com/s3ntin3l8/mullion-session-manager/commit/f0699c430be67986fd83328dfde9c99dd2f4b217))
* **tasks:** round-cap banner claims "needs a human" before the machine stops ([#1040](https://github.com/s3ntin3l8/mullion-session-manager/issues/1040)) ([f9bfde2](https://github.com/s3ntin3l8/mullion-session-manager/commit/f9bfde21cfb248c7baad094a1812ba2b54f81e0f))
* **tasks:** salvage WIP commits for remote-hosted tasks ([#1125](https://github.com/s3ntin3l8/mullion-session-manager/issues/1125)) ([f25023a](https://github.com/s3ntin3l8/mullion-session-manager/commit/f25023ace2210911359c8f8cb85f38f3fac11fa8))
* **tasks:** session-death's worktree removal races an in-flight re-seed ([0696f69](https://github.com/s3ntin3l8/mullion-session-manager/commit/0696f695ec8367abace888dadc106339bf74d749))
* **test:** give the multi-host self-registers test a real timeout ([#1070](https://github.com/s3ntin3l8/mullion-session-manager/issues/1070)) ([24b398a](https://github.com/s3ntin3l8/mullion-session-manager/commit/24b398a5485f5583c23c1a5a258f84badfe13836))
