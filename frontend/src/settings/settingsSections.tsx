...
export const SECTIONS: Array<{
  ...
  },
  {
    ...
    group: "Workspace",
    title: "Browser",
    desc: "Stream quality and sign-in cookies for a project's browser pane.",
  ...
  },
  {
    ...
    group: "Connections",
    title: "Integrations",
    desc: "GitHub account, webhooks, GitHub Apps, and update checks.",
  ...
  },
  {
    ...
    group: "System",
    title: "Server",
    desc: "Diagnostics, logging, storage, and updates.",
...
export const SEARCH_INDEX: Array<{ section: SettingsSection; text: string }> = [
  ...
  { section: "tasks", text: "rate limit grace period quota" },
  ...
  { section: "browser", text: "stream frame rate fps smoothness bandwidth" },
  ...
  { section: "hosts", text: "health check heartbeat interval" },
  ...
  { section: "integrations", text: "update checks polling interval active quiet webhook silence" },
  ...
  { section: "server", text: "log level logging debug trace verbosity" },
  { section: "server", text: "features browser pane android devices discovery" },
