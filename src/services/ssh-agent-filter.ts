 ...
 * second implementation lives in the Mullion Helper worker and verifies
 * itself against test/fixtures/ssh-agent-filter-vectors.json, generated by
 * scripts/generate-ssh-agent-filter-vectors.ts. This server table remains
 * the source of truth; `SIGN_ONLY_ALLOWLIST` is derived from it.
 *
